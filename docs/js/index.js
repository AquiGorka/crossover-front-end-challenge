...
/***/ (function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  return _reactDom2.default.render(_react2.default.createElement(_app2.default, null), document.getElementById('root'));
	}); //
	...
	var styles = {
		...
		extendedStatus: {
			wrapper: (_wrapper = {
				...
				flexGrow: 1,
				fontSize: 12
			}, _defineProperty(_wrapper, 'boxSizing', 'border-box'), _defineProperty(_wrapper, 'display', 'flex'), _defineProperty(_wrapper, 'alignItems', 'center'), _defineProperty(_wrapper, 'paddingLeft', 10), _defineProperty(_wrapper, 'background', '#F2F2F2'), _defineProperty(_wrapper, 'borderLeft', '1px solid #E3E3E6'), _defineProperty(_wrapper, 'fontSize', 20), _defineProperty(_wrapper, 'justifyContent', 'center'), _wrapper),
			text: {
				marginLeft: 5
			},
			icon: {
	...
	var styles = {
		...
		build: {
			wrapper: (_wrapper = {
				...
				width: '33.333333%',
				display: 'flex'
			}, _defineProperty(_wrapper, 'display', 'flex'), _defineProperty(_wrapper, 'justifyContent', 'center'), _defineProperty(_wrapper, 'alignItems', 'flex-start'), _wrapper),
			item: {
				flexGrow: 1,
				display: 'flex',
				alignItems: 'center',
